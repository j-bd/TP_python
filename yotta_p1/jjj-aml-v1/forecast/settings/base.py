...
DATA_FILE = os.path.join(RAW_DATA_DIR, 'data.csv')
DATA_WITHOUT_TARGET_FILE = os.path.join(RAW_DATA_DIR, 'data_without_target.csv')
SOCIO_ECO_FILE = os.path.join(RAW_DATA_DIR, 'socio_eco.csv')
PREDICT_FILE = os.path.join(PROCESSED_DATA_DIR, 'data_socio_predict.csv')
