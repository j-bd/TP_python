...
with open("package/scores", "wb") as scores_file:
    ...
    while attempt < pack.donnees.LIFE:
        ...
        if "*" not in gamer_answer:
            ...
            print(f"Vous avez perdu. La reponse est {pack.fonctions.display_word(word_to_guess)}")
